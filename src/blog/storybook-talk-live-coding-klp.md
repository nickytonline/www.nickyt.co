---json
{
  ...
  "cover_image": "http://localhost:8080/images/posts/_practicaldev_image_fetch_s--nDJchRza--_c_imagga_scale,f_auto,fl_progressive,h_420,q_auto,w_1000_https:__dev-to-uploads.s3.amazonaws.com_uploads_articles_436wuamj05szgisfdtrm.jpeg",
...
![Describing building components in Storybook vs. your applciation](http://localhost:8080/images/posts/_uploads_articles_6x3jsi7yoj9id3xyhgg3.png)
...
![The Forem mention autocomplete component in action in Forem's Storybook](http://localhost:8080/images/posts/_uploads_articles_3s1qbca47opj18adanwh.png)
...
![Different views of a button component in different states in Storybook](http://localhost:8080/images/posts/_uploads_articles_mw0e2cmaf72ybu2t78e4.png)
