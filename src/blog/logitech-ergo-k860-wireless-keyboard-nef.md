---json
{
  ...
  "cover_image": "http://localhost:8080/images/posts/_practicaldev_image_fetch_s--HlKm0oYL--_c_imagga_scale,f_auto,fl_progressive,h_420,q_auto,w_1000_https:__dev-to-uploads.s3.amazonaws.com_uploads_articles_g7z1ueuhxcqrqlb11tbd.JPG",
...
![Logitech LogiOptions software for Logitech devices, currently displaying a picture of the ERGO K860 keyboard settings screen](http://localhost:8080/images/posts/_uploads_articles_npt3fthk51vvi162ismz.png)
...
![Logitech LogiOptions software for Logitech devices, currently displaying a picture of the ERGO K860 keyboard settings screen where the F12 key was clicked, displaying the options you have for the F12 key](http://localhost:8080/images/posts/_uploads_articles_1u16uxq6guqv7jumn57y.png)

There are more options if you click on the More link.

![Logitech LogiOptions software for Logitech devices, currently displaying a picture of the ERGO K860 keyboard settings screen where the F12 key was clicked, displaying the expanded options you have for the F12 key](http://localhost:8080/images/posts/_uploads_articles_krwnaic4tu6414b5omjx.png)
...
![LogiOptions software open on the keyboard settings showing keys outlined in white that can be remapped including the Print Screen key](http://localhost:8080/images/posts/_uploads_articles_55gqpfbgmfj6gpwempty.png)
...
![The keystroke assignment window to remap the Print Screen key](http://localhost:8080/images/posts/_uploads_articles_osai6yn70ofwtkvrkv4f.png)
...
![Three keys labeled 1, 2, and 3 with a tiny computer icon on each on the ERGO K860 keyboard to switch between devices](http://localhost:8080/images/posts/_uploads_articles_5vxnwtzdopn7dwsmmi4o.png) 
