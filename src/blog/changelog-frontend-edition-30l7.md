---json
{
  ...
  "cover_image": "http://localhost:8080/images/posts/_practicaldev_image_fetch_s--RbUzG7vH--_c_imagga_scale,f_auto,fl_progressive,h_420,q_auto,w_1000_https:__dev-to-uploads.s3.amazonaws.com_i_taavig1ker0pmxi35grk.png",
...
![Screenshot of DEV's Storybook](http://localhost:8080/images/posts/_i_6r9hi9d4dzks6xg830dn.png)
...
![Screenshot of DEV's Storybook theme switcher](http://localhost:8080/images/posts/_i_5m5nmopxsvq7l4g8jywe.png)
...
![Screenshot of jest test runner options in watch mode](http://localhost:8080/images/posts/_i_6alsv3g4epkpn9r84qgy.png)

![Screenshot of jest test runner options in watch mode for filtering test files based on filename](http://localhost:8080/images/posts/_i_i4yqse0rnlxpsfmydy4e.png)
