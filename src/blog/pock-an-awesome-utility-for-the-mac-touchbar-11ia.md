---json
{
  ...
  "cover_image": "http://localhost:8080/images/posts/_practicaldev_image_fetch_s--wu3fsFJF--_c_imagga_scale,f_auto,fl_progressive,h_420,q_auto,w_1000_https:__thepracticaldev.s3.amazonaws.com_i_1lnsa2cfa2m4oogcas4f.jpg",
...
![Keyboard preferences for mapping function keys in touch bar for certain apps](http://localhost:8080/images/posts/_i_5xj2scviq8o2kivnyhy0.png)
...
![Pock in action](http://localhost:8080/images/posts/_i_qyf7zba4vejkjcjvd6lu.jpg)
