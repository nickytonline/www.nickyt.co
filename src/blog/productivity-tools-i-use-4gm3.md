---json
{
  ...
  "cover_image": "http://localhost:8080/images/posts/_practicaldev_image_fetch_s--HY1BAZDa--_c_imagga_scale,f_auto,fl_progressive,h_420,q_auto,w_1000_https:__dev-to-uploads.s3.amazonaws.com_uploads_articles_6o3ie5mp1y2ki6xpra6q.jpeg",
...
![Raycast Search](http://localhost:8080/images/posts/_uploads_articles_rrrls5ct9ld8ezq47tl0.png)
...
![Dato Calendar App](http://localhost:8080/images/posts/_uploads_articles_0upcfu8ujartdzhy2tw1.png)
...
![Fig autocomplete in action](http://localhost:8080/images/posts/_uploads_articles_avp5xo335g46nqi3bmot.png)
...
![Webcam Settings App Advanced Settings screen](http://localhost:8080/images/posts/_uploads_articles_icjqvz75vduidpdgjq7g.png)
...
![CleanMyMac X main screen](http://localhost:8080/images/posts/_uploads_articles_n8c10p80b897e6npwm86.png)
...
![Cleanshot X image editor](http://localhost:8080/images/posts/_uploads_articles_zok86bqim1grwy4hur1x.png)
...
![Starship shell prompt in action](http://localhost:8080/images/posts/_uploads_articles_9w2uut5vy2kvaavazjg0.png)
 
* [mcfly](https://github.com/cantino/mcfly) - An enhance search for your shell history. Super charged <kbd>CTRL</kbd> + <kbd>R</kbd>!

![mcfly shell history search in action](http://localhost:8080/images/posts/_uploads_articles_fvjdht5vlmrj2xqcchs5.png)
