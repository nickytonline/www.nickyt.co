---json
{
  ...
  "cover_image": "http://localhost:8080/images/posts/_practicaldev_image_fetch_s--LtbkdgH0--_c_imagga_scale,f_auto,fl_progressive,h_420,q_auto,w_1000_https:__dev-to-uploads.s3.amazonaws.com_uploads_articles_a5quwfpvmt36uxvrfj2j.jpeg",
...
![Polywork assitant](http://localhost:8080/images/posts/_uploads_articles_hoaz3ladpk05d9endst0.png)
...
![Polywork badges section](http://localhost:8080/images/posts/_uploads_articles_bwyf96wnsevx9juwoe7a.png)

## Positions

Like other professional networks, you can add the positions you've held.

![Polywork positions section](http://localhost:8080/images/posts/_uploads_articles_wmqggolywg2d1sm3ubu5.png)
...
![Polywork ended and started a new role highlights](http://localhost:8080/images/posts/_uploads_articles_k3994nynfjawd5cwl5iw.png) 

### Timeline

The main area of prominence on your profile page is the timeline.

![A Polywork highlight about me taking time off](http://localhost:8080/images/posts/_uploads_articles_p27njvml14ijk8zkmcmz.png)
...
![Creating a Polywork highlight](http://localhost:8080/images/posts/_uploads_articles_1v4e0m9pa4y1or766tcy.png)
...
![Polywork add a tag](http://localhost:8080/images/posts/_uploads_articles_bdbbeyyzc4csct3re9db.png)

If a tag does not exist, you can create it.

![Polywork create new tag](http://localhost:8080/images/posts/_uploads_articles_wo8bormdpemvme4ctchx.png)
...
![Polywork adding a collaborator button](http://localhost:8080/images/posts/_uploads_articles_1dd0mrd7z9bjh352ptdr.png)

You can add as many collaborators as you want. I'm sure there is a limit; I just haven't reached it yet. 😎

![Polywork add collaborators](http://localhost:8080/images/posts/_uploads_articles_ayczagfav0fuz2mzhp33.png)
...
![A Polywork reposted highlight of the DEV Twitch stream with Ben Hong](http://localhost:8080/images/posts/_uploads_articles_17rxhti3wp0zp2l2915e.png)
...
![Polywork, filtering your timeline](http://localhost:8080/images/posts/_uploads_articles_3odk7f4cmxm45bcq2np7.png)
...
![Polywork, filtering timeline with badge](http://localhost:8080/images/posts/_uploads_articles_weeqa2jg82w1mha7jxe2.png)
...
![Polywork, set up a custom domain](http://localhost:8080/images/posts/_uploads_articles_2cttxmz8boembroh3ypb.png)
...
![Polywork contact preferences modal](http://localhost:8080/images/posts/_uploads_articles_xhltgezs5akylwspnvyi.png)
...
![Polywork multiverse page](http://localhost:8080/images/posts/_uploads_articles_dmvsd3klg67x8ty5rj3w.png)
...
![Polywork space station page](http://localhost:8080/images/posts/_uploads_articles_prvxn4um6ka0pfs3owmg.png)
...
![Submit an issue to Polywork](http://localhost:8080/images/posts/_uploads_articles_lj7r7de2xg0s4z7eesf4.png) 
