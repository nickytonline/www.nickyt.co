---json
{
  ...
  "cover_image": "http://localhost:8080/images/posts/_practicaldev_image_fetch_s--kzB8DJTv--_c_imagga_scale,f_auto,fl_progressive,h_420,q_auto,w_1000_https:__dev-to-uploads.s3.amazonaws.com_uploads_articles_7sjay11pqa91it8euj0l.png",
...
![](http://localhost:8080/images/posts/_uploads_articles_s5csqewe14a9n4kr523d.png)
...
![data variable in VS Code displaying autocomplete with properties of the data object](http://localhost:8080/images/posts/_uploads_articles_w5o2nxl0hik2gwhpy6m1.png)
...
![The type PersonalInfo displaying its shape in CodeSandbox](http://localhost:8080/images/posts/_uploads_articles_g5sbz0a6386yfgwz7376.png)
