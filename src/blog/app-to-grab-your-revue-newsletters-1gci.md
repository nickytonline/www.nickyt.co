---json
{
  ...
  "cover_image": "http://localhost:8080/images/posts/_practicaldev_image_fetch_s--mINhBz4F--_c_imagga_scale,f_auto,fl_progressive,h_420,q_auto,w_1000_https:__dev-to-uploads.s3.amazonaws.com_uploads_articles_vhn3sri34nx84esgy3ii.png",
...
![Drop down on the Revue Subscribers page with an option to export all subscribers](http://localhost:8080/images/posts/_uploads_articles_rmqf3723msiuv81ykoun.png)
