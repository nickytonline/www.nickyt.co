---json
{
  ...
  "cover_image": "http://localhost:8080/images/posts/_practicaldev_image_fetch_s--L53rXEkz--_c_imagga_scale,f_auto,fl_progressive,h_420,q_auto,w_1000_https:__dev-to-uploads.s3.amazonaws.com_i_4or5dqsjdsqzf3jfsr7t.png",
...
![Twitch Channel Settings](http://localhost:8080/images/posts/_i_d82fvqzkqo6jda6jwste.png)
...
![Adding Twitch API key to OBS stream preferences](http://localhost:8080/images/posts/_i_qwdarbwg14rfv2grm3x9.png)
...
![OBS display source showing a black screen](http://localhost:8080/images/posts/_i_tlh0xcnanhfbpfpljx97.png)
...
![Grant access to Screen Recording under Security & Privacy for OBS](http://localhost:8080/images/posts/_i_fd59j6ejad2gpywybjna.png)

![OBS display source working](http://localhost:8080/images/posts/_i_buqf8e5u5gt4oqixxsed.png)
