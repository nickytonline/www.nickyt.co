---json
{
  ...
  "cover_image": "http://localhost:8080/images/posts/_practicaldev_image_fetch_s--ZLSdtlQa--_c_imagga_scale,f_auto,fl_progressive,h_420,q_auto,w_1000_https:__dev-to-uploads.s3.amazonaws.com_uploads_articles_15nikfupur01dk91ng88.png",
...
![List of projects that the Project Manager VS Code extension is aware of](http://localhost:8080/images/posts/_uploads_articles_3lxmhrcuigniwmrmxjoh.png)
...
![The VS Code command menu open with the Project Manager: Save Project command in the list](http://localhost:8080/images/posts/_uploads_articles_gnupeg2g5vmsrhgpvwgo.png)
...
![The Project Manager extension setting the name of the project to save to the name of the folder that is currently open in VS Code](http://localhost:8080/images/posts/_uploads_articles_8fd6ro3jv8ylro689u5u.png)

Now when you go open the list of projects, your new project will be on the list.

![List of projects that the Project Manager VS Code extension is aware of including the newly added project we just added](http://localhost:8080/images/posts/_uploads_articles_p1nb5p87mx3owvzugbux.png)
