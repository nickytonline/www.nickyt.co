...
date: '2021-12-30T17:00:00.000Z'
excerpt: 'Like last year, 2021 has been quite the year. Despite the pandemic, I stayed healthy'
tags:
  - yearinreview
template: post
...
<iframe class="liquidTag" src="https://dev.to/embed/twitter?args=1474400617271599105" style="border: 0; width: 100%;"></iframe>
...
<iframe class="liquidTag" src="https://dev.to/embed/link?args=https:%2F%2Fdev.to%2Fnickytonline%2Fstorybook-talk-live-coding-klp" style="border: 0; width: 100%;"></iframe>
...
<iframe class="liquidTag" src="https://dev.to/embed/twitter?args=1472684903460487168" style="border: 0; width: 100%;"></iframe>
...
<iframe class="liquidTag" src="https://dev.to/embed/link?args=https:%2F%2Fdev.to%2Fnickytonline%2Fgetting-started-with-streaming-on-twitch-4im7" style="border: 0; width: 100%;"></iframe>
...
{%youtube 'https://www.youtube.com/watch?v=cyJAz-c1OWs' %}
...
<iframe class="liquidTag" src="https://dev.to/embed/twitter?args=1440766175353335814" style="border: 0; width: 100%;"></iframe>

The second workshop was on accessibility with my other awesome co-worker Suzanne Aitchison.

<iframe class="liquidTag" src="https://dev.to/embed/twitter?args=1441210447982743554" style="border: 0; width: 100%;"></iframe>
...
<iframe class="liquidTag" src="https://dev.to/embed/twitter?args=1441121683100684290" style="border: 0; width: 100%;"></iframe>
...
<iframe class="liquidTag" src="https://dev.to/embed/github?args=https:%2F%2Fgithub.com%2Fnickytonline%2Fweb3-starter" style="border: 0; width: 100%;"></iframe>
...
Back to my favourite community, Virtual Coffee, [I had the privilege of being the podcast's first guest](https://virtualcoffee.io/podcast/0101-nickyt/). It was awesome chilling with my friends Bekah and Dan.
...
We discussed [Visual Studio Code and all things related to it](https://dev.to/devdiscuss/s6-e7-vs-code-and-the-extended-vs-code-universe).
...
And to round off the year of podcasts, I got to hang with my co-workers Ben Halpern and Arit Amana, along with Michael Boroff, mental health program manager at Crossover Health to [discuss imposter syndrome](https://dev.to/devdiscuss/s7-e7-we-have-tools-to-help-you-with-your-imposter-syndrome).
...
<iframe class="liquidTag" src="https://dev.to/embed/link?args=https:%2F%2Fdev.to%2Fnickytonline%2Fwhy-i-created-the-vscodetips-community-2bl" style="border: 0; width: 100%;"></iframe>

We’re also on Product Hunt!

<iframe class="liquidTag" src="https://dev.to/embed/twitter?args=1437497275786440705" style="border: 0; width: 100%;"></iframe>
...
<iframe class="liquidTag" src="https://dev.to/embed/twitter?args=1462065499634913282" style="border: 0; width: 100%;"></iframe>
