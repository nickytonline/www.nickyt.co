...
<script>
  ...
  window.dispatchEvent(
    new CustomEvent('syncSearchForms', {detail: {querystring: location.search}})
  );
</script>
```
...
// See search.html.erb.
document.body.innerHTML = '<div id="mobile-search-container"><form></form></div>';
```
...
_[This post is also available on DEV.](https://dev.to/nickytonline/testing-preact-react-portals-with-testing-library-52ja)_
